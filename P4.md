...
```
    ...
    Duración de la simulación:  27.457398653030396
    2514 errores, para un BER de 0.0059.
    




    <matplotlib.image.AxesImage at 0x1dbb2c189a0>
...
```
    ...
    Duración de la simulación:  44.24037289619446
    ...
    <matplotlib.image.AxesImage at 0x1dbb3059e20>
...
```
    ...
    <ipython-input-30-9fc3e17c5175>:9: DeprecationWarning: Using scipy.fft as a function is deprecated and will be removed in SciPy 1.5.0, use scipy.fft.fft instead.
      senal_f = fft(senal_Tx)
